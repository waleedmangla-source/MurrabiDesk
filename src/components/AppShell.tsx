          ...
          >
            <div className="relative">
              ...
              <img
                src="/text-logo.png"
                alt="Murabbi Desk"
                className="relative z-10 h-32 w-auto object-contain animate-pulse mix-blend-multiply opacity-95 drop-shadow-md"
              />
            </div>
