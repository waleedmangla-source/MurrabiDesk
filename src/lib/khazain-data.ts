...
export const THEOLOGICAL_TOPIC_MAP: Record<string, string[]> = {
  ...
  // Marriage, Family & Matrimony
  "marriage": ["نکاح", "شادی", "ازدواج", "زوجہ", "عقد"],
  "nikah": ["نکاح", "شادی", "ازدواج"],
  "wedding": ["شادی", "نکاح", "ولیمہ"],
  "matrimony": ["نکاح", "ازدواج"],
  "spouse": ["زوج", "زوجہ", "بیوی", "شوہر", "ازدواج"],
  "spouses": ["ازواج", "بیویاں"],
  "husband": ["شوہر", "خاوند", "میاں"],
  "wife": ["زوجہ", "بیوی", "اہلیہ", "عورت"],
  "wives": ["ازواج", "بیویاں"],
  "divorce": ["طلاق", "خلع"],
  "talaq": ["طلاق", "تفریق"],
  "khula": ["خلع", "طلاق"],
  "family": ["خاندان", "اہل بیت", "کنبہ", "اولاد"],
  "children": ["اولاد", "بچے", "فرزند"],
  "parents": ["والدین", "ماں باپ"],
  "mother": ["ماں", "والدہ", "ام"],
  "father": ["باپ", "والد", "اب"],
  "polygamy": ["تعدد ازدواج", "چار شادیاں", "بیویاں"],
  "purdah": ["پردہ", "حجاب", "حیا"],
  "veil": ["پردہ", "حجاب"],
  "hijab": ["پردہ", "حجاب", "ستر"],
  "modesty": ["حیا", "شرم و حیا", "طہارت"],
  "chastity": ["عصمت", "طہارت", "پاکدامنی"],
  "dowry": ["مہر", "حق مہر", "جہیز"],
  "mehr": ["مہر", "حق مہر"],
  "walima": ["ولیمہ", "شادی"],

  // Worship, Pillars & Religious Practice
  "namaz": ["نماز", "صلوٰۃ", "باجماعت"],
  "salat": ["صلوٰۃ", "نماز"],
  "tahajjud": ["تہجد", "شب بیداری"],
  "fasting": ["روزہ", "صوم", "صیام", "رمضان"],
  "fast": ["روزہ", "صوم"],
  "roza": ["روزہ", "صوم", "افطار"],
  "ramadan": ["رمضان", "رمضان المبارک", "ماہ رمضان"],
  "ramzan": ["رمضان", "روزہ"],
  "zakat": ["زکوٰۃ", "صدقہ", "اموال"],
  "charity": ["صدقہ", "خیرات", "انفاق فی سبیل اللہ", "زکوٰۃ"],
  "sadaqah": ["صدقہ", "خیرات"],
  "almsgiving": ["زکوٰۃ", "صدقہ"],
  "hajj": ["حج", "بیت اللہ", "طواف", "احرام"],
  "pilgrimage": ["حج", "عمرہ", "زیارت"],
  "umrah": ["عمرہ", "طواف"],
  "worship": ["عبادت", "بندگی", "پرستش"],
  "ibadat": ["عبادت", "طاعت"],
  "ablution": ["وضو", "طہارت"],
  "wudu": ["وضو", "طہارت"],
  "taharat": ["طہارت", "پاکیزگی"],
  "cleanliness": ["صفائی", "طہارت", "پاکیزگی"],
  "funeral": ["جنازہ", "نماز جنازہ", "تدفین"],
  "janaza": ["جنازہ", "تجہیز و تکفین"],

  // Khilafat, Community & Bai'at
  "khilafat": ["خلافت", "خلیفہ", "قدرت ثانیہ"],
  "caliphate": ["خلافت", "خلیفۃ المسیح"],
  "khalifa": ["خلیفہ", "خلیفۃ المسیح"],
  "baiat": ["بیعت", "عہد بیعت", "شرائط بیعت"],
  "bai'at": ["بیعت", "عہد بیعت"],
  "pledge": ["بیعت", "عہد"],
  "qudrat-e-thaniyya": ["قدرت ثانیہ", "خلافت"],
  "second manifestation": ["قدرت ثانیہ", "خلافت"],
  "wasiyyat": ["وصیت", "نظام وصیت", "بہشتی مقبرہ"],
  "the will": ["الوصیت", "نظام وصیت"],
  "musleh maud": ["مصلح موعود", "پیشگوئی مصلح موعود"],
  "chanda": ["چندہ", "مالی قربانی", "انفاق"],
  "financial sacrifice": ["مالی قربانی", "چندہ"],
  "waqf": ["وقف", "وقف زندگی", "وقف نو"],
  "waqf-e-nau": ["وقف نو"],
  "tahrik-e-jadid": ["تحریک جدید"],
  "waqf-e-jadid": ["وقف جدید"],
  "tabligh": ["تبلیغ", "اشاعت اسلام", "دعوت الی اللہ"],
  "tarbiyat": ["تربیت", "اصلاح نفس"],
  "talim": ["تعلیم", "علم"],
  "murabbi": ["مربی", "مربی سلسلہ", "داعی الی اللہ"],
  "jamia": ["جامعہ احمدیہ"],

  // Morality & Social Conduct
  "truth": ["سچائی", "صدق", "حق"],
  "truthfulness": ["سچائی", "صدق", "راستی"],
  "honesty": ["دیانت داری", "امانت", "راستی"],
  "patience": ["صبر", "استقامت", "تحمل"],
  "sabr": ["صبر", "استقامت"],
  "gratitude": ["شکر", "شکر گزاری"],
  "shukr": ["شکر", "احسان مندی"],
  "forgiveness": ["عفو", "بخشش", "مغفرت", "معافی"],
  "humility": ["انکساری", "عاجزی", "فروتنی"],
  "arrogance": ["تکبر", "غرور", "کبر"],
  "pride": ["تکبر", "فخر"],
  "anger": ["غصہ", "غضب"],
  "jealousy": ["حسد", "کینہ"],
  "backbiting": ["غیبت", "بدگوئی"],
  "lies": ["جھوٹ", "کذب", "دروغ"],
  "lying": ["جھوٹ", "کذب"],
  "kindness": ["احسان", "نیکی", "حسن سلوک", "ہمدردی"],
  "love": ["محبت", "عشق الٰہی", "الفت"],
  "justice": ["عدل", "انصاف", "قسط"],
  "service": ["خدمت خلق", "ہمدردی"],
  "service to humanity": ["خدمت خلق", "ہمدردی خلق"],
  "trust": ["امانت", "توکل"],
  "tawakkul": ["توکل", "بھروسہ"],
  "women": ["عورت", "خواتین", "مستورات", "عورتوں کے حقوق"],
  "woman": ["عورت", "خاتون"],
  "rights of women": ["حقوق نسواں", "عورتوں کے حقوق"],

  // Economics & Daily Life
  "inheritance": ["وراثت", "ترکہ", "تقسیم ترکہ"],
  "usury": ["سود", "ربا"],
  "interest": ["سود", "ربا"],
  "riba": ["ربا", "سود"],
  "debt": ["قرض", "ادائے قرض"],
  ...
  "wealth": ["مال", "دولت"],
  "poverty": ["غربت", "افلاس", "فقر"],
  "food": ["طعام", "کھانا", "طیب"],
  "halal": ["حلال", "طیب"],
  "haram": ["حرام", "ممنوع"],
  "alcohol": ["شراب", "خمر", "نشہ"],
  "wine": ["شراب", "خمر"],
  "gambling": ["قمار بازی", "جوا", "میسر"],
  "pork": ["سور", "خنزیر", "گوشت خنزیر"],
  "health": ["صحت", "تندرستی"],
  "illness": ["بیماری", "مرض"],
  "medicine": ["دوا", "علاج", "شفا"],
  "healing": ["شفا", "صحت"],

  // Eschatology, Creation & Universe
  "creation": ["تخلیق", "پیدائش", "پیدائش عالم"],
  "universe": ["کائنات", "عالم", "افلاک"],
  "evolution": ["ارتقاء", "نظریہ ارتقاء"],
  "science": ["سائنس", "علم طبائع", "حکمت"],
  "reason": ["عقل", "برہان", "استدلال"],
  "death": ["موت", "وفات", "اجل"],
  "grave": ["قبر", "مزار"],
  "resurrection": ["قیامت", "حشر", "بعث بعد الموت"],
  "day of judgment": ["قیامت", "روز جزا", "حشر"],
  "intercession": ["شفاعت", "شفیع"],
  "satan": ["شیطان", "ابلیس"],
  "devil": ["شیطان", "ابلیس"],
  "dajjal": ["دجال", "دجال اکبر"],
  "antichrist": ["دجال", "مسیح دجال"],
  "gog and magog": ["یاجوج ماجوج"],
